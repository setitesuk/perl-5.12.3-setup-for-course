...
"darwin-2level-9.8.0" or
	die "Errno architecture (darwin-2level-9.8.0) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
...
@EXPORT_OK = qw(EBADMACHO ENOMSG ELAST EROFS ENOTSUP ESHUTDOWN EAUTH
	...
	ECONNRESET EWOULDBLOCK EBADMSG EDOM EPROGMISMATCH EMSGSIZE ENOPOLICY
